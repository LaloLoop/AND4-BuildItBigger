...
package com.skycreateware.android.nanodegree.builditbigger.backend;
...
@Api(
  ...
  namespace = @ApiNamespace(
    ownerDomain = "backend.builditbigger.nanodegree.android.skycreateware.com",
    ownerName = "backend.builditbigger.nanodegree.android.skycreateware.com",
    packagePath=""
  )
)
